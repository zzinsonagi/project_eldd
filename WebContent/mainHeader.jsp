			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					<li><a class="nav-link1" href="sub1.do">選んでみて!</li>
					<li><a class="nav-link2" href="sub2.do">条件検索</li>
					<li><a class="nav-link3" href="sub3.do">キーワード</li>
					<li><a class="nav-link4" href="sub4.do">ランキング</li>
				  </ul>
