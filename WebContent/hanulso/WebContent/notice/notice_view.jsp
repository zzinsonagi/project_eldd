...
<%@ include file="/header.jsp"%>
	...
	<div class="container">
		<div class="board_view">
			<h2>${vo.title }</h2>
			<p class="info"><span class="user">${vo.writer }</span> ${vo.wdate } <i class="fa fa-eye"></i> ${vo.viewcount }</p>
			...
			<div class="prev_next">
				...
				<div class="btn_3wrap">
					...
					<a href="noticemodify.do?idx=${vo.idx }">수정</a>
					<a href="noticedelete.do?idx=${vo.idx }" onClick="return confirm('삭제하시겠어요?')">삭제</a>
				</div>
